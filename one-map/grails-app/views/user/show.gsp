	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.craft}">
				<li class="fieldcontain">
					<span id="craft-label" class="property-label"><g:message code="user.craft.label" default="Craft" /></span>
					
						<span class="property-value" aria-labelledby="craft-label"><g:fieldValue bean="${userInstance}" field="craft"/></span>
